...
void ClientPrecache( void )
{
	...
	CBaseEntity::PrecacheScriptSound( "Player.DoubleJump" );
	...
	// Hit Sounds
	CBaseEntity::PrecacheScriptSound("Player.HitSoundBody");
	CBaseEntity::PrecacheScriptSound("Player.HitSoundHead");
