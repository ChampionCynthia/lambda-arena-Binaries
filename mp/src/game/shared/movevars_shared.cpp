...
#else
ConVar	sv_airaccelerate(  "sv_airaccelerate", "100", FCVAR_NOTIFY | FCVAR_REPLICATED ); // [Striker] Expose this.   
...
ConVar	sv_footsteps	( "sv_footsteps", "1", FCVAR_NOTIFY | FCVAR_REPLICATED, "Play footstep sound for players" );
ConVar	sv_rollspeed	( "sv_rollspeed", "200", FCVAR_NOTIFY | FCVAR_REPLICATED );
ConVar	sv_rollangle	( "sv_rollangle", "1.0", FCVAR_NOTIFY | FCVAR_REPLICATED, "Max view roll angle");
#endif // CSTRIKE_DLL
